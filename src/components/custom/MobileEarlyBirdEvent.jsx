  ...
  return (
    <div id="MobileEarlyBirdEvent">
      <div className="wrapper">
        ...
        <div className="desc">
          <p>
            오직 사전등록 완료자에게만 발행되는 <br />
            <b>[2025 시큐업 얼리버드 배지]</b>를
          </p>
          <p>
            행사 당일 <b>현장 등록데스크에서 인증</b>해주시면 <br />
        ...
        <span>
          (사전등록 완료 후, 3일 내 제출해주신 메일주소로 <br /> [2025 시큐업
          얼리버드배지]가 발송됩니다.)
        </span>
      </div>
...
export default MobileEarlyBirdEvent;
