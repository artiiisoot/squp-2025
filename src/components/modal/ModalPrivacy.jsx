          ...
          <div className="modal-dialog">
            ...
            <div className="modal-body">
              <div className="context">
                ...
                <p>
                  라온시큐어(주)(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에
                ...
                <ul>
                  ...
                  <li>
                    1. 홈페이지 회원 가입 및 관리 회원 가입 의사 확인, 회원제
                    서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리,
                    제한적 본인확인제 시행에 따른 본인확인, 서비스 부정 이용
                    방지, 만 14세 미만 아동의 개인정보처리 시 법정대리인의 동의
                    여부 확인, 각종 고지․통지, 고충 처리 등을 목적으로
                    개인정보를 처리합니다.
                  </li>

                  <li>
                    2. 재화 또는 서비스 제공 물품 배송, 서비스 제공, 계약서 및
                    청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증,
                    연령인증, 요금 결제 및 정산, 채권추심 등을 목적으로
                    개인정보를 처리합니다.
                  </li>

                  <li>
                    3. 고충 처리 민원인의 신원 확인, 민원사항 확인, 사실조사를
                    위한 연락․통지, 처리 결과 통보 등의 목적으로 개인정보를
                    처리합니다.
                  </li>
                </ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <p>
                        ...
                        탈퇴 시까지 다만, 다음의 사유에 해당하는 경우에는 해당
                        사유 종료 시까지
                      </p>
                      <li>
                      ...
                      <li>
                        2) 홈페이지 이용에 따른 채권 및 채무관계 잔존 시에는
                        해당 채권, 채무 관계 정산 시까지
                      </li>
                    </ul>
                    <ul>
                      <p>
                        ...
                        요금결제․정산 완료 시까지 다만, 다음의 사유에 해당하는
                        경우에는 해당 기간 종료 시까지
                      </p>
                      <li>
                        <p>
                      ...
                      <li>
                        <p>
                          2) 「통신비밀보호법」 제41조에 따른 통신사실확인자료
                          보관
                        </p>
                        <ul>
                          <li>
                            - 가입자 전기통신일시, 개시․종료 시간, 상대방 가입자
                            번호, 사용도수, 발신기지국 위치추적자료 : 1년
                          </li>
                          <li>
                            - 컴퓨터 통신, 인터넷 로그 기록자료, 접속지 추적자료
                            : 3개월
                          </li>
                        </ul>
                      </li>
                ...
                <ul>
                  <p>제3조(정보주체 및 법정대리인의 권리와 그 행사 방법)</p>
                  <li>
                    <p>
                      {" "}
                ...
                <ul>
                  <p>제4조(처리하는 개인정보 항목)</p>
                  <p>회사는 다음의 개인정보 항목을 처리하고 있습니다.</p>
                  <li>시큐업 2025 사전 등록 및 디지털 배지 발급</li>
                  <li>
                    필수항목 : 이름, 휴대폰번호, 이메일, 회사명, 부서명,
                    직급/직책
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        1. 파기 절차 회사는 파기 사유가 발생한 개인정보를
                        선정하고, 회사의 개인정보 보호책임자의 승인을 받아
                        개인정보를 파기합니다.
                      </li>
                      <li>
                        2. 파기 방법 회사는 전자적 파일 형태로 기록․저장된
                ...
                <ul>
                  ...
                  <li>
                    ...
                    이용자의 컴퓨터 브라우저에 보내는 소량의 정보이며 이용자들의
                    PC 또는 모바일에 저장됩니다.
                  </li>
                  <li>
                    <p>
                      ③ 정보주체는 웹 브라우저 옵션 설정을 통해 쿠키 허용, 차단
                      등의 설정을 할 수 있습니다. 다만, 쿠키 저장을 거부할 경우
                      맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.
                    </p>
                    <ul>
                      <p>▶ 웹 브라우저에서 쿠키 허용/차단</p>
                      <li>
                        - 크롬(Chrome) : 웹 브라우저 설정 &gt; 개인정보 보호 및
                        보안 &gt; 인터넷 사용기록 삭제
                      </li>
                      <li>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      개인정보 처리와 관련한 정보주체의 불만 처리 및 피해구제
                  ...
                  <li>
                    ...
                    발생한 모든 개인정보 보호 관련 문의, 불만 처리, 피해구제
                    등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실
                    수 있습니다. 회사는 정보주체의 문의에 대해 지체없이 답변 및
                    처리해드릴 것입니다.
                  </li>
                </ul>
                ...
                <p>제11조(개인정보 처리방침 시행 및 변경)</p>
                <p>이 개인정보 처리방침은 2025. 8. 1. 부터 적용됩니다.</p>
              </div>
            </div>
