...
const MobileReservationListPage = () => {
  ...
  return (
    <>
      ...
      <article id="MobileReservationListPage">
              ...
              popperProps={{
                modifiers: [
                  ...
                  },
                  {
                    ...
                    enabled: false,
                    options: {
                      fallbackPlacements: [], // ✅ 빈 배열로 설정 (위로 flip 방지)
                    },
                  },
                  {
...
export default MobileReservationListPage;
