  ...
  return (
    <article id="Privacy">
      <div className="page-container">
        ...
        <p>
          라온시큐어(주)(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라
        ...
        <ul className="num">
          <li>
            <p>
              1. 홈페이지 회원 가입 및 관리회원 가입 의사 확인, 회원제 서비스
              제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제
              시행에 따른 본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의
              개인정보처리 시 법정대리인의 동의 여부 확인, 각종 고지․통지, 고충
              처리 등을 목적으로 개인정보를 처리합니다.
            </p>
          </li>
          <li>
            <p>
              2. 재화 또는 서비스 제공물품 배송, 서비스 제공, 계약서 및 청구서
              발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금 결제
              및 정산, 채권추심 등을 목적으로 개인정보를 처리합니다.
            </p>
          </li>
          <li>
            <p>
              3. 고충 처리민원인의 신원 확인, 민원사항 확인, 사실조사를 위한
              연락․통지, 처리 결과 통보 등의 목적으로 개인정보를 처리합니다.
            </p>
          </li>
        </ul>
        <b>
        ...
        <ul className="num">
          <li>
            <p>
              ...
              시까지다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료 시까지
            </p>

            <ul className="num-children">
              <li>
                <p>
          ...
          <li>
            <p>
              ...
              완료 시까지다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료
              시까지
            </p>
        ...
        <ul className="num">
          ...
          <li>
            <p>
              5. 정보주체는 개인정보 보호법 등 관계 법령을 위반하여 회사가
        ...
        <p>
          시큐업 2025 사전 등록 및 디지털 배지 발급 <br />
          필수항목 : 이름, 휴대폰번호, 이메일, 회사명, 부서명, 직급/직책
        </p>
        <b>
          <p>제5조(개인정보의 파기)</p>
        </b>
        <ul className="num">
          ...
          <li>
            <p>
              2. 정보주체로부터 동의받은 개인정보 보유 기간이 경과하거나
          ...
          <li>
            ...
            <ul className="num-children">
              <li>
                <p>
                  1). 파기 절차 : 회사는 파기 사유가 발생한 개인정보를 선정하고,
        ...
        <ul className="num">
          ...
          <li>
            <p>
              ...
              접근통제시스템 설치, 고유 식별정보등의 암호화, 보안프로그램 설치
            </p>
          </li>
          <li>
        ...
        <ul className="num">
          <li>
            <p>
              1. 회사는 이용자에게 개별적인 맞춤 서비스를 제공하기 위해
          ...
          <li>
            <p>
              ...
              컴퓨터 브라우저에 보내는 소량의 정보이며 이용자들의 PC 또는
              모바일에 저장됩니다.
            </p>
          </li>
          <li>
            <p>
              3. 정보주체는 웹 브라우저 옵션 설정을 통해 쿠키 허용, 차단 등의
          ...
          <li>
            <p>
              4. 회사는 서비스 이용과정에서 사용자가 방문한 각 서비스와 웹
            ...
            <ul className="num-children">
              ...
              <li>
                ...
                <ul className="hyphen">
                  ...
                  <li>
                    <p>- 이메일 : marketing@raoncorp.com</p>
                  </li>
                </ul>
              </li>
            </ul>
